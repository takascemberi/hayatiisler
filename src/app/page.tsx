    ...
    <main className="relative min-h-screen bg-black text-white">
      ...
      <div className="absolute inset-0 -z-10">
        <Image
          ...
          priority
        />
        {/* Katmanı azaltılmış, yazıyı boğmaz */}
        <div className="absolute inset-0 bg-black/20" />
      </div>

      {/* ✅ Başlıklar */}
      <header className="pt-8 pb-4 text-center">
        <h1 className="text-5xl md:text-7xl font-extrabold bg-gradient-to-r from-yellow-300 via-red-500 via-purple-500 via-indigo-500 to-blue-700 bg-clip-text text-transparent drop-shadow-lg animate-pulse">
          Hayati İşler
        </h1>
      ...
      <section className="py-16 px-6 bg-black/90 text-center">
