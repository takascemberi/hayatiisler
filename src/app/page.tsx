    ...
    <main className="bg-white text-black relative overflow-hidden">
      ...
      <div className="relative h-[85vh] w-full">
        ...
        <div className="absolute top-10 w-full flex flex-col items-center justify-start text-center px-4 z-10">
          ...
          <h2 className="text-[36px] md:text-[72px] mt-2 font-bold text-black drop-shadow-[0_4px_8px_rgba(255,215,0,0.9)] animate-bounce">
            Urfa Sıra Gecesi
          </h2>
        </div>
      </div>
      ...
      <section className="bg-white py-24 px-6 text-center">
        <h3 className="text-3xl font-bold mb-16 text-black drop-shadow">Neden Hayati İşler?</h3>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Kutu 1 */}
          <div className="rounded-3xl p-6 shadow-xl bg-gradient-to-br from-yellow-300 via-orange-400 to-red-500 hover:scale-105 transition-all duration-300 text-black">
          ...
          {/* Kutu 2 */}
          <div className="rounded-3xl p-6 shadow-xl bg-gradient-to-br from-pink-600 via-purple-600 to-indigo-500 hover:scale-105 transition-all duration-300 text-white">
          ...
          {/* Kutu 3 */}
          <div className="rounded-3xl p-6 shadow-xl bg-gradient-to-br from-teal-500 via-green-500 to-emerald-500 hover:scale-105 transition-all duration-300 text-white">
